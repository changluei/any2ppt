...
export type Source = { id:string; project_id:string; original_name:string; media_type:string; size:number; status:'uploaded'|'parsing'|'indexing'|'ready'|'failed'; error_message?:string; created_at:string; updated_at:string }
