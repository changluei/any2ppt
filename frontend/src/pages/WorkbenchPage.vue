...
/* The editor shell owns the viewport. Only the message thread scrolls. */
.editor-body{min-height:0;overflow:hidden}
.ai-sidebar{height:100%;min-height:0;max-height:100%;overflow:hidden}
.assistant-chat{
  flex:1 1 0;
  min-height:0;
  overflow-x:hidden;
...
.chat-message{flex:0 0 auto;min-width:0;overflow-wrap:anywhere}
.chat-composer{position:relative;z-index:1;flex:0 0 auto}
</style>
